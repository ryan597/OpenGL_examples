...
auto main() -> int
{
    ...
    const std::string vertexShaderSource = loadShaderSource( "../ex4/TransformVertexShader.vertexshader");
    const std::string fragmentShaderSource = loadShaderSource("../ex4/ColorFragmentShader.fragmentshader");
    ...
    {
        glfwTerminate();
        std::cout << "Shaders not loaded. Terminating.\n";
        //std::getchar();
        return -1;
    }
