...
auto main() -> int
{
    ...
    std::string vertexShaderSource = loadShaderSource("../ex2/SimpleVertexShader.vertexshader");
    std::string fragmentShaderSource = loadShaderSource("../ex2/SimpleFragmentShader.fragmentshader");
